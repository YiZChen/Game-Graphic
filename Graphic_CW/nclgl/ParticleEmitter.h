...
public:
	ParticleEmitter(bool, char* texturePath, bool);
	...
	*/
	...
	void    SetWindPower(float w) { this->windEffect = w; }
	float   GetWindPower() { return windEffect; }
...
protected:
	...
	*/
	...
	bool isAreaSpawner;			//if it is, then the particle emitter from an area

	bool isAllDirectionSpawner;
